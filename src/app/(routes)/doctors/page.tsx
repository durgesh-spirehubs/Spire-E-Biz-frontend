...
const Doctors = () => {
  ...
  const allColumns: Column<User>[] = [
    { header: "ID", accessor: "id", sortable: true, isVisible: true },
    {
      header: "Name",
      accessor: "name",
      sortable: true,
    ...
    { header: "Role", accessor: "role", isVisible: true },
  ];
  ...
  return (
    <MainCard
      ...
      action={<Button>Add Doctor</Button>}
      options={
...
Doctors.routePermission = ["Admin", "Doctor"];
